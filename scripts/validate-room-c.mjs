...
).filter((artwork) => artwork.roomId === "C");

if (artworks.length !== 8) {
  throw new Error("Room C must contain exactly eight artworks.");
}
...
console.log(`Room C validated: ${artworks.length} artworks and readable images.`);
